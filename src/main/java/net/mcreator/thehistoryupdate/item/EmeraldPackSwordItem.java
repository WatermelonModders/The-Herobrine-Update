...
public class EmeraldPackSwordItem extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:emerald_pack_sword")
	public static final Item block = null;

	public EmeraldPackSwordItem(TheHistoryUpdateModElements instance) {
		super(instance, 28);
	}
