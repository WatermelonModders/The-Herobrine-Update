...
public class EmeraldShovelItem extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:emerald_shovel")
	public static final Item block = null;

	public EmeraldShovelItem(TheHistoryUpdateModElements instance) {
		super(instance, 33);
	}
