...
public class LimestoneItem extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:limestone")
	public static final Item block = null;

	public LimestoneItem(TheHistoryUpdateModElements instance) {
		super(instance, 36);
	}
