package net.mcreator.thehistoryupdate.entity.renderer;
...
public class GhoulRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GhoulEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelghould(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_history_update:textures/ghoul.png");
					}
				};
			});
		}
	...
	public static class Modelghould extends EntityModel<Entity> {
