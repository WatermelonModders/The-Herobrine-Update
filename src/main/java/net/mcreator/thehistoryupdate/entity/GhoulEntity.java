...
package net.mcreator.thehistoryupdate.entity;
...
public class GhoulEntity extends TheHistoryUpdateModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("ghoul").setRegistryName("ghoul");

	public GhoulEntity(TheHistoryUpdateModElements instance) {
		super(instance, 17);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16724839, -10040320, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ghoul_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("the_history_update:the_lyre_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 50, 4, 4));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zombie.infect"));
		}
