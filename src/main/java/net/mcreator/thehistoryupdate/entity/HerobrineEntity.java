...
public class HerobrineEntity extends TheHistoryUpdateModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.95f)).build("herobrine").setRegistryName("herobrine");

	public HerobrineEntity(TheHistoryUpdateModElements instance) {
		super(instance, 14);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737997, -3342490, new Item.Properties().group(ItemGroup.MISC))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.NETHERITE_HELMET));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Items.BOW));
		}
