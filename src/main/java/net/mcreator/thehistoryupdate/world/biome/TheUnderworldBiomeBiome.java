...
public class TheUnderworldBiomeBiome extends TheHistoryUpdateModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10092544).setWaterColor(-10092544).setWaterFogColor(329011)
						.withSkyColor(-10092544).withFoliageColor(-10092544).withGrassColor(-16751104)
