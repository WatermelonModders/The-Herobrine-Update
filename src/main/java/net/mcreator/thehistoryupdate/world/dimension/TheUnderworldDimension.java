...
import net.mcreator.thehistoryupdate.item.TheUnderworldItem;
...
public class TheUnderworldDimension extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:the_underworld_portal")
	public static final CustomPortalBlock portal = null;

	public TheUnderworldDimension(TheHistoryUpdateModElements instance) {
		super(instance, 25);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("the_history_update:the_underworld"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("the_underworld_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("the_underworld_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("the_underworld_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new TheUnderworldItem().setRegistryName("the_underworld"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("the_underworld_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("the_history_update:the_underworld"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("the_history_update:the_underworld")));
				} else {
					entity.func_242279_ag();
