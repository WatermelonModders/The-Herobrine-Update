...
import net.mcreator.thehistoryupdate.item.TheLooterItem;
...
public class TheLooterDimension extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:the_looter_portal")
	public static final CustomPortalBlock portal = null;

	public TheLooterDimension(TheHistoryUpdateModElements instance) {
		super(instance, 26);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("the_history_update:the_looter"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("the_looter_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("the_looter_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("the_looter_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new TheLooterItem().setRegistryName("the_looter"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("the_looter_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("the_history_update:the_looter"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("the_history_update:the_looter")));
				} else {
					entity.func_242279_ag();
