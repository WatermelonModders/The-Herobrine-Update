...
public class AdvancedTableUIGui extends TheHistoryUpdateModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public AdvancedTableUIGui(TheHistoryUpdateModElements instance) {
		super(instance, 30);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("advanced_table_ui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AdvancedTableUIGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			AdvancedTableProcedureProcedure
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 62) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 43, 62) {
			}));
			...
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 7, 44) {
			}));
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 7, 26) {
			}));
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 25, 26) {
			}));
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 43, 26) {
			}));
			this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 61, 26) {
			}));
			this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 7, 8) {
				@Override
			...
			this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 25, 8) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 43, 8) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(15, this.addSlot(new SlotItemHandler(internal, 15, 61, 8) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				TheHistoryUpdateMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
