...
public class ObsidianBlockBlock extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:obsidian_block")
	public static final Block block = null;

	public ObsidianBlockBlock(TheHistoryUpdateModElements instance) {
		super(instance, 116);
	}
