...
public class HardenedAmethystBlockBlock extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:hardened_amethyst_block")
	public static final Block block = null;

	public HardenedAmethystBlockBlock(TheHistoryUpdateModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardened_amethyst_block");
		}
