...
public class LimestoneBlockBlock extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:limestone_block")
	public static final Block block = null;

	public LimestoneBlockBlock(TheHistoryUpdateModElements instance) {
		super(instance, 38);
	}
