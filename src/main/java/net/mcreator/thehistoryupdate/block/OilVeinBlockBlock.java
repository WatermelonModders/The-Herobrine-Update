...
public class OilVeinBlockBlock extends TheHistoryUpdateModElements.ModElement {
	@ObjectHolder("the_history_update:oil_vein_block")
	public static final Block block = null;

	public OilVeinBlockBlock(TheHistoryUpdateModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("oil_vein_block");
		}
